...
from utils.GTSRBDataSet import Loader
...
kernel_size, padding, poolsize =9, 5, 4
padding_value = 1
A = [[1,           8,           kernel_size,       2,       padding,       padding_value,       poolsize,        2],
     ...
     [64,         256,           kernel_size,       1,       padding,       padding_value,       poolsize,        2],
     [256,        classes_num,  kernel_size,       1,       padding,       padding_value,       poolsize,        2],
     ]
...
summary(model=model,
        input_size=(batch_size, 1, 784),  # make sure this is "input_size", not "input_shape"
